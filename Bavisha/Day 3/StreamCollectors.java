...
public class StreamCollectors {
	...
	private static List<Integer> getMultiplesOfFive(){
		List<Integer> five=IntStream.iterate(0, i -> i+5).mapToObj(Integer::valueOf).limit(20).collect(Collectors.toList());
		return five;
	...
	public static void main(String[] args) {
		...
		List<Integer> multiplesOfFive = getMultiplesOfFive();
		System.out.println("multiples of five"+multiplesOfFive);
	}
